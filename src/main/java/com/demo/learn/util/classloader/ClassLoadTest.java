package com.demo.learn.util.classloader;

import com.demo.learn.util.classloader.test.TestA;
import com.demo.learn.util.classloader.test.TestB;
...
//        loadClassByClassLoader();
    ...
    static void loadClassByName() throws Exception {
        // 普通加载，会执行初始化块
        Class<TestA> aClass = (Class<TestA>) Class.forName("com.demo.learn.util.classloader.test.TestA");

        // 指定不执行初始化块
        Class<?> bClass = Class.forName("com.demo.learn.util.classloader.test.TestB", false, TestB.class.getClassLoader());
    ...
    static void loadClassByClassLoader() throws Exception {
        ...
        // 加载类，不会执行初始化块
        Class<?> aClass = loader.loadClass("com.demo.learn.util.classloader.test.TestA");
